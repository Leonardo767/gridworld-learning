...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, name='critic', fc1_dims=256, fc2_dims=256, chkpt_dir='tmp/sac'):
        ...
        self.chkpt_file = os.path.join(self.chkpt_dir, self.name+'_sac')
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, max_action=0, name='actor', fc1_dims=256, fc2_dims=256, n_actions=2, chkpt_dir='tmp/sac'):
